package org.metadatacenter.cedar.workspace.config;
...
public class CedarConfigWorkspaceTest {
  ...
  public void testGetInstance() throws Exception {
    SystemComponent systemComponent = SystemComponent.SERVER_WORKSPACE;
